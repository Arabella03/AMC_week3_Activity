    ...
    <SafeAreaProvider>
      <SafeAreaView>
        <View style={styles.inputContainer}>
          <Icon name="account-circle" size={24} color="blue" style={styles.icon} />
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputContainer}>
          <Icon name="accessibilitage" size={24} color="black" style={styles.icon} />
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputContainer}>
          <Icon name="home" size={24} color="green" style={styles.icon} />
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputContainer}>
          <Icon name="info" size={24} color="red" style={styles.icon} />
          <TextInput
            editable
            multiline
            numberOfLines={4}
